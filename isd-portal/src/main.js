...
async function initApp() {
  ...
  if (currentHash === '#portal') {
    ...
    if (currentUser) {
      ...
      // Explicitly anchor Director/Executive dashboard privileges to your account
      const isDirectorAccount = currentUser.email.toLowerCase() === 'trevormuseti@gmail.com' || displayName.toLowerCase().includes('trevor');
      const userRole = isDirectorAccount ? 'director' : dbRole;
      const isExecutive = isDirectorAccount;
