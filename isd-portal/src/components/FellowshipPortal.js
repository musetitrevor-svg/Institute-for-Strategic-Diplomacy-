...
export async function renderFellowshipPortal(container) {
    ...
    <section id="fellowship" class="py-16 px-6 lg:px-10 bg-paper border-t border-ink-200">
      <div class="max-w-2xl mx-auto space-y-8">
        <div class="text-center space-y-2">
          <span class="text-xs uppercase tracking-[0.25em] text-bronze-600 font-bold font-sans">Talent Pipeline</span>
          <h2 class="font-serif text-3xl md:text-4xl text-ink-900">Research Fellowship Application</h2>
        ...
        <form id="fellowship-form" class="bg-paper border border-ink-200 rounded-lg p-8 shadow-sm space-y-6">
          <div class="space-y-1">
            <label class="block text-xs font-bold uppercase tracking-wider text-ink-700 font-sans">Full Legal Name</label>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="space-y-1">
              <label class="block text-xs font-bold uppercase tracking-wider text-ink-700 font-sans">Institutional Email</label>
          ...
          <div class="space-y-1">
            <label class="block text-xs font-bold uppercase tracking-wider text-ink-700 font-sans">Academic & Professional Statement</label>
  ...
  form.addEventListener('submit', async (e) => {
    ...
    try {
      ...
      submitBtn.textContent = 'Submit Candidacy';
    }
  });
}